...
// Бекенд (Фаза 0) не має ендпоінта для "featured/showcase" контенту — це
// заглушка, яку варто замінити реальною вибіркою робіт, щойно такий
// ендпоінт з'явиться. Тримаємо її тут, а не в коді сторінки, щоб усі
// посилання-заглушки на зображення були зібрані в одному місці.

export interface HomeCollageTile {
  image: string
  label: string
  count: string
  /** col-span/row-span у сітці 5×2 (сума span'ів має дорівнювати 10) */
  className: string
  dark?: boolean
}
