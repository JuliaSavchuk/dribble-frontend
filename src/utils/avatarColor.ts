...
/**
 * Детермінований вибір пастельного кольору з палітри за юзернеймом:
 * той самий користувач завжди отримує той самий колір аватара-заглушки,
 * а різні користувачі, як правило, отримують візуально різні кольори —
 * так само, як це працює у Gmail.
 *
 * Навмисно НЕ використовується Math.random(): справжня випадковість
 * означала б, що колір аватара змінювався б при кожному рендері чи
 * перезавантаженні сторінки — а саме такого "дивного відображення"
 * і потрібно уникнути.
 */
